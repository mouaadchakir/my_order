...
<div class="container mx-auto px-4 py-8">
    <h1 class="text-2xl font-bold mb-6 text-gray-800">Edit User: {{ $user->name }}</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <form action="{{ route('admin.users.update', $user->id) }}" method="POST">
            ...
            <div class="mb-4">
                ...
                <p class="text-gray-600 text-xs italic mt-2">Leave blank to keep the current password.</p>
            </div>
